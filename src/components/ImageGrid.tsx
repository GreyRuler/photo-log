                    ...
                    <Drawer key={nanoid()}>
                        ...
                        <DrawerContent className="text-white bg-primary border-none h-dvh">
                            ...
                            <DrawerFooter className="pt-2 grid grid-cols-2">
                                <DrawerClose asChild>
                                    <Button className="bg-slate-900 font-bold text-red-500 w-full text-base border focus:bg-red-500 focus:text-white border-red-900" variant="outline" onClick={() => onDelete(image.id)}>Удалить</Button>
                                </DrawerClose>
                                <Button className="bg-slate-900 font-bold text-blue-500 w-full text-base border focus:bg-blue-500 focus:text-white border-blue-500" variant="outline" onClick={() => onDownload(image.path)}>Скачать</Button>
                            </DrawerFooter>
                        </DrawerContent>
                    </Drawer>
                ))}
